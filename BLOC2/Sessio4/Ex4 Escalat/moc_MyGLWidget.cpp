...
QT_MOC_LITERAL(1, 11, 12), // "set_value_qt"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1), // "x"
QT_MOC_LITERAL(4, 27, 11) // "actualitzar"

    },
    "MyGLWidget\0set_value_qt\0\0x\0actualitzar"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->set_value_qt((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->actualitzar((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::set_value_qt)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::set_value_qt(int _t1)
{
