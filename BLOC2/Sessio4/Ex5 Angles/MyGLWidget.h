...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  private:
    ...
    float dist = 10, angle = M_PI, zoom = 0;
    ...
    bool DoingInteractive;

  signals:
    void canvi_angle_x(int x);
    void canvi_angle_y(int y);


  public slots:
    void actualitzar_angle_x(int x);
    void actualitzar_angle_y(int y);
