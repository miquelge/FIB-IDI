...
void MyGLWidget::createBuffers () {
  ...
  m2.load("/Users/Miquelge/Desktop/IDI/uni/models/legoman.obj");
  ...
  glGenBuffers(1, &VBO_Col2);
  glBindBuffer(GL_ARRAY_BUFFER, VBO_Col2);
...
void MyGLWidget::projectTransform () {
  ...
  glm::mat4 Proj;
  if (ortho_mola) Proj = glm::ortho (l, r, b, t, znear, zfar);
...
void MyGLWidget::canvi_proj (bool b) {
    makeCurrent();
    ortho_mola = b;
    projectTransform();
    update();
