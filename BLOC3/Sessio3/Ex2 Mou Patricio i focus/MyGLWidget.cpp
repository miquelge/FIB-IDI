...
void MyGLWidget::modelTransformPatricio () {
  ...
  TG = glm::translate(TG, glm::vec3(varx, -0.85, varz));
...
void MyGLWidget::projectTransform () {
  ...
  if (perspectiva) Proj = glm::perspective(float(M_PI/3.0), 1.0f, radiEsc, 3.0f*radiEsc);
  else Proj = glm::ortho(-radiEsc, radiEsc, -radiEsc, radiEsc, radiEsc, 3.0f*radiEsc);
...
void MyGLWidget::calculaCapsaModel () {
  ...
  centrePatr[0] = (minx+maxx)/2.0; centrePatr[1] = ((miny+maxy)/2); centrePatr[2] = (minz+maxz)/2.0;
}
